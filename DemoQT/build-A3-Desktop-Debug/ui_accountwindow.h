...
public:
    ...
    void setupUi(QWidget *AccountWindow)
    {
        ...
        backButton = new QPushButton(AccountWindow);
        backButton->setObjectName("backButton");
        backButton->setGeometry(QRect(300, 390, 100, 32));
    ...
    void retranslateUi(QWidget *AccountWindow)
    {
        ...
        backButton->setText(QCoreApplication::translate("AccountWindow", "Back", nullptr));
    } // retranslateUi
