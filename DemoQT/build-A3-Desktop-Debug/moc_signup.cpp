...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSignUpENDCLASS_t qt_meta_stringdata_CLASSSignUpENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 13),  // "showGameBoard"
        QT_MOC_LITERAL(21, 0),  // ""
        QT_MOC_LITERAL(22, 15),  // "showLoginWindow"
        QT_MOC_LITERAL(38, 20),  // "on_picButton_clicked"
        QT_MOC_LITERAL(59, 21),  // "on_buttonBox_accepted"
        QT_MOC_LITERAL(81, 21)   // "on_buttonBox_rejected"
    },
    "SignUp",
    "showGameBoard",
    "",
...
void SignUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->showGameBoard(); break;
        case 1: _t->showLoginWindow(); break;
        case 2: _t->on_picButton_clicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &SignUp::showGameBoard; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SignUp::*)();
            if (_t _q_method = &SignUp::showLoginWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SignUp::showGameBoard()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignUp::showLoginWindow()
{
